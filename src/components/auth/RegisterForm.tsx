...
const RegisterForm = ({ setState }: Props) => {
    return (
        <form className="w-full mx-auto grid gap-4 p-4 h-full">
            ...
            <button className="mt-6 bg-teal-500 text-black font-bold px-6 py-2 flex items-center border-r border-b-2 border-b-black border-r-black shadow-lg w-3/4 mx-auto transition-colors hover:bg-[#41AAAD] duration-300 ease-in-out gap-2 content-center text-2xl">
                <p className="mx-auto">Sigin</p>
                <span className="ml-2">
                    <FaUserCheck />
                </span>
            </button>
